	...
	<c:if test='${not empty info.info}'>
      ...
      <table class="contentTable">
        ...
        <tr> 
          ...
          <td class="<c:out value='${rowClass}' />"><a href="invoiceServlet/I_<c:out value='${invoice.documentNo}'/>.pdf?Invoice_ID=<c:out value='${invoice.c_Invoice_ID}'/>" target="_blank"><img src="images/pdf.gif" alt="Get Invoice Image" width="30" height="30" border="0"></a></td>

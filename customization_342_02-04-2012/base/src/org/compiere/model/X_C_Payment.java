...
// S
	...
	/** Set RefundTxn.
		@param RefundTxn 
		Used to flag if a transaction is of type REFUND.
	  */
	public void setRefundTxn (boolean RefundTxn)
	{
		set_Value (COLUMNNAME_RefundTxn, Boolean.valueOf(RefundTxn));
	}

	/** Get RefundTxn.
		@return Used to flag if a transaction is of type REFUND.
	  */
	public boolean isRefundTxn () 
	{
		Object oo = get_Value(COLUMNNAME_RefundTxn);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 

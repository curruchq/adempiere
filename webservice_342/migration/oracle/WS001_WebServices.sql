...
INSERT INTO AD_Window (AD_Client_ID,AD_Org_ID,AD_Window_ID,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDefault,IsSOTrx,Name,Processing,Updated,UpdatedBy,WindowType,WinHeight,WinWidth) VALUES (0,0,53068,TO_DATE('2009-01-30 17:57:08','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N','N','Y','Web Service Security','N',TO_DATE('2009-01-30 17:57:08','YYYY-MM-DD HH24:MI:SS'),100,'M',0,0)
;
...
ALTER TABLE WS_WebServiceType ADD (CONSTRAINT SearchKey_WSWebServiceType UNIQUE (Value));

ALTER TABLE WS_WebServiceType ADD (CONSTRAINT Name_WSWebServiceType UNIQUE (Name));

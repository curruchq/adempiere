...
public class WPAttributeInstance extends Window implements EventListener 
{
	...
	private Checkbox hideAssigned = new Checkbox(); // JH
	//
	...
	private void init() throws Exception
	{
		...
		hideAssigned.setLabel(Msg.getMsg(Env.getCtx(), "HideAssigned")); // JH
		...
		box.appendChild(hideAssigned); // JH
		hideAssigned.addEventListener(Events.ON_CHECK, this); // JH
	...
	private String  m_sqlHideAssigned = " AND asi.M_AttributeSetInstance_ID NOT IN ( SELECT asi.M_ATTRIBUTESETINSTANCE_ID FROM M_ATTRIBUTESETINSTANCE asi, M_INOUT io, M_INOUTLINE iol, C_DOCTYPE dt WHERE asi.M_ATTRIBUTESETINSTANCE_ID = iol.M_ATTRIBUTESETINSTANCE_ID AND io.M_INOUT_ID = iol.M_INOUT_ID AND io.C_DOCTYPE_ID = dt.C_DOCTYPE_ID AND dt.DOCBASETYPE LIKE 'MMS')"; // JH
	...
	public void onEvent(Event e) throws Exception 
	{
		...
		// JH
		else if (e.getTarget() == hideAssigned)
		{
			refresh();
		}

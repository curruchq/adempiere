...
public class InfoLinkTag extends TagSupport
{
	...
	private void menuBPartner (HtmlCode html, MStore wstore)
	{
		...
		// TODO: add isSIPAccounts to wstore
		if (true)
		{
			nl(html, first);		//		--- SIP Accounts
			first = false;
			a a = new a (SIPServlet.DEFAULT_JSP);
			a.setClass("menuSub");
			a.addElement("My SIP Accounts");
			html.addElement(a);
		}
		
		// TODO: add isSubscriptions to wstore
		if (true)
		{
			nl(html, first);		//		--- Subscriptions
			first = false;
			a a = new a (SubscriptionsTableTag.DEFAULT_JSP);
			a.setClass ("menuSub");
			a.addElement ("My Subscriptions");
			html.addElement (a);
		}
		
		// TODO: add isCCValidation to wstore
		if (true)
		{
			nl(html, first);		//		--- Creditcard Validation
			first = false;
			a a = new a (CreditCardValidationServlet.DEFAULT_JSP);
			a.setClass ("menuSub");
			a.addElement ("Creditcard Validation");
			html.addElement (a);
		}
		
		if (true)
		{			
			nl(html, first);		//		--- Call recordings
			a a = new a(CallRecordingServlet.JSP_DEFAULT);
			a.setClass("menuSub");
			a.addElement("Call Recordings");
			html.addElement(a);
		}
	}	//	menuCustomer
	...
	private void menuUser (HtmlCode html, boolean isEmployee, MStore wstore)
	{
		...
		{			
			//							--- Create Product
			a a = new a("createProduct.jsp");
			a.setClass("menuMain");
			a.addElement("Create Product");
			html.addElement(a);
			...
			a.setClass("menuMain");
			a.setTarget("_blank");
			a.setOnClick("return popUpSearch(this.href, 'Search');");
			a.addElement("Search");
			html.addElement(a);

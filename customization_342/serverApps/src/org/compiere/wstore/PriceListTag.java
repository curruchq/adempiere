...
public class PriceListTag extends TagSupport
{
	...
	public int doStartTag() throws JspException
	{
		...
		// Load all records id - JH
		boolean allRecords = (searchString == null || searchString.length() < 1) && (productCategory == null || productCategory.length() < 1 || productCategory.equals("-1"));
		
		//	get price list
		m_priceList = PriceList.get (ctx, AD_Client_ID, M_PriceList_ID, 
			searchString, productCategory, allRecords);
		if (M_PriceList_ID == 0)

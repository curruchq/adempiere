...
<div id="main">
			...
			<table class="internalTable">
				<tr>
					<td class="lineItem">
						...
						<img src="images/Calendar16.gif" border="0"/>
						<br/>
					...
					<td class="lineItem">
						...
						<label>Amount</label>
						<input type="text"/>
						<img src="images/Calculator16.gif" border="0"/>
						<br/>
    ...
    <c:choose>
    	<c:when test="${info.expenses}.size() > 0">
			<div class="tableNav">
				<img src="images/wfStart24.gif" onclick="alert('CLICK');">
				<img src="images/wfBack24.gif" onclick="alert('CLICK');">
				Page 1
				<img src="images/wfNext24.gif" onclick="alert('CLICK');">
				<img src="images/wfEnd24.gif" onclick="alert('CLICK');">
			</div>
		</c:when>
	</c:choose>

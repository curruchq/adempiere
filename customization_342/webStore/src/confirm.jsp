...
<div id="main">
	...
	<h1>Thanks - Payment Confirmation</h1>
      <c:if test='${not empty showDIDMsg}'>
      	<c:set var="sipAccountJSP" value="<%= org.compiere.wstore.SIPServlet.DEFAULT_JSP %>"/>
      	<div id="infoMsg">
      		<a href="/<c:out value='${sipAccountJSP}'/>">Click here to edit your SIP account settings..</a>
        </div>
      </c:if>
        ...
        <tr> 
          ...
          <td class="oddRow">
		    ...
		    <c:when test='${not empty webOrder}'>
			  <a href="invoiceServlet/I_<c:out value='${webOrder.invoiceInfo}'/>.pdf?Invoice_ID=<c:out value='${webOrder.invoice_ID}'/>" target="_blank"><img src="images/pdf.gif" alt="Get Invoice PDF" width="30" height="30" border="0" align="right"></a>

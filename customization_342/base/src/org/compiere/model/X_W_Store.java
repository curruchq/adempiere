...
// Y
	...
	/** Set No Reply EMail.
		@param NoReplyEMail No Reply EMail	  */
	public void setNoReplyEMail (String NoReplyEMail)
	{
		if (NoReplyEMail == null)
			throw new IllegalArgumentException ("NoReplyEMail is mandatory.");

		if (NoReplyEMail.length() > 60)
		{
			log.warning("Length > 60 - truncated");
			NoReplyEMail = NoReplyEMail.substring(0, 60);
		}
		set_Value (COLUMNNAME_NoReplyEMail, NoReplyEMail);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_NoReplyEMail);
	}

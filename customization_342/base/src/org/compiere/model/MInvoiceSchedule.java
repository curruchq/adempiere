...
{
	/** Static Logger  - JH			*/
	private static CLogger	s_log	= CLogger.getCLogger (MInvoiceSchedule.class);
	...
	/**
	 * Get MInvoiceSchedule by Invoice Day (used by Web Store to update 
	 * invoice schedule when creating new user - JH)
	 * @param ctx
	 * @param invoiceDay
	 * @param trxName
	 * @return
	...
	public static MInvoiceSchedule getByInvoiceDay (Properties ctx, int invoiceDay, String trxName)
	{
		...
		MInvoiceSchedule retValue = null;

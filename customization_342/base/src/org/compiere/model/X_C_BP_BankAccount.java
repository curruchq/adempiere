...
public class X_C_BP_BankAccount extends PO implements I_C_BP_BankAccount, I_Persistent 
{
    ...
    public X_C_BP_BankAccount (Properties ctx, int C_BP_BankAccount_ID, String trxName)
    {
      ...
      /** if (C_BP_BankAccount_ID == 0)
        {
			setA_Name (null);
			setBP_CC_Validated (false);
// N
			setBP_CC_ValidationAmount (Env.ZERO);
// 0
			setBP_CC_ValidationInvalidCount (0);
// 0
	...
	/** Set BP_CC_Validated.
		@param BP_CC_Validated BP_CC_Validated	  */
	public void setBP_CC_Validated (boolean BP_CC_Validated)
	{
		set_Value (COLUMNNAME_BP_CC_Validated, Boolean.valueOf(BP_CC_Validated));
	}

	/** Get BP_CC_Validated.
		@return BP_CC_Validated	  */
	public boolean isBP_CC_Validated () 
	{
		Object oo = get_Value(COLUMNNAME_BP_CC_Validated);
		if (oo != null) 
		{
	...
	/** Set BP_CC_ValidationAmount.
		@param BP_CC_ValidationAmount BP_CC_ValidationAmount	  */
	public void setBP_CC_ValidationAmount (BigDecimal BP_CC_ValidationAmount)
	{
		if (BP_CC_ValidationAmount == null)
			throw new IllegalArgumentException ("BP_CC_ValidationAmount is mandatory.");
		set_Value (COLUMNNAME_BP_CC_ValidationAmount, BP_CC_ValidationAmount);
	}

	/** Get BP_CC_ValidationAmount.
		@return BP_CC_ValidationAmount	  */
	public BigDecimal getBP_CC_ValidationAmount () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_BP_CC_ValidationAmount);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** Set BP_CC_ValidationDateCharged.
		@param BP_CC_ValidationDateCharged BP_CC_ValidationDateCharged	  */
	public void setBP_CC_ValidationDateCharged (Timestamp BP_CC_ValidationDateCharged)
	{
		set_Value (COLUMNNAME_BP_CC_ValidationDateCharged, BP_CC_ValidationDateCharged);
	}

	/** Get BP_CC_ValidationDateCharged.
		@return BP_CC_ValidationDateCharged	  */
	public Timestamp getBP_CC_ValidationDateCharged () 
	{
		return (Timestamp)get_Value(COLUMNNAME_BP_CC_ValidationDateCharged);
	}

	/** Set BP_CC_ValidationInvalidCount.
		@param BP_CC_ValidationInvalidCount BP_CC_ValidationInvalidCount	  */
	public void setBP_CC_ValidationInvalidCount (int BP_CC_ValidationInvalidCount)
	{
		set_Value (COLUMNNAME_BP_CC_ValidationInvalidCount, Integer.valueOf(BP_CC_ValidationInvalidCount));
	}

	/** Get BP_CC_ValidationInvalidCount.
		@return BP_CC_ValidationInvalidCount	  */
	public int getBP_CC_ValidationInvalidCount () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_BP_CC_ValidationInvalidCount);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

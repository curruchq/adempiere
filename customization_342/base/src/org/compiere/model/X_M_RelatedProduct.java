...
public class X_M_RelatedProduct extends PO implements I_M_RelatedProduct, I_Persistent 
{
	...
	/** Setup - one off = O */
	public static final String RELATEDPRODUCTTYPE_Setup_OneOff = "O";
	...
	public void setRelatedProductType (String RelatedProductType)
	{
		...
		if (RelatedProductType.equals("P") || RelatedProductType.equals("A") || RelatedProductType.equals("S") || RelatedProductType.equals("O")); else throw new IllegalArgumentException ("RelatedProductType Invalid value - " + RelatedProductType + " - Reference_ID=313 - P - A - S - O");

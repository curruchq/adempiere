...
// 1
	...
	@param Qty 
	The Quantity */
	public void setPeriodQty (BigDecimal PeriodQty)
	{
		/*if (PeriodQty == null)
			throw new IllegalArgumentException ("PeriodsQty is mandatory.");*/
		set_Value (COLUMNNAME_PeriodQty, PeriodQty);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_PeriodQty);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

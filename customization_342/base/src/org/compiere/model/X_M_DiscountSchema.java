...
// Y
	...
	/** Invoice = I */
	public static final String CUMULATIVELEVEL_Invoice = "I";
	...
	public void setCumulativeLevel (String CumulativeLevel)
	{
		...
		if (CumulativeLevel == null || CumulativeLevel.equals("L") || CumulativeLevel.equals("I")); else throw new IllegalArgumentException ("CumulativeLevel Invalid value - " + CumulativeLevel + " - Reference_ID=246 - L - I");
	...
	/** Set Apply Maximum Discount.
		@param IsApplyMaxDiscount 
		Apply maximum discount on Invoice Lines as configured in Discount Breaks
	  */
	public void setIsApplyMaxDiscount (boolean IsApplyMaxDiscount)
	{
		set_Value (COLUMNNAME_IsApplyMaxDiscount, Boolean.valueOf(IsApplyMaxDiscount));
	}

	/** Get Apply Maximum Discount.
		@return Apply maximum discount on Invoice Lines as configured in Discount Breaks
	  */
	public boolean isApplyMaxDiscount () 
	{
		Object oo = get_Value(COLUMNNAME_IsApplyMaxDiscount);
		if (oo != null) 
		{

...
public class X_C_PaymentProcessor extends PO implements I_C_PaymentProcessor, I_Persistent 
{
	...
	/** Set CertFilename.
		@param CertFilename 
		Filename of certificate to use with the Payment Processor.
	  */
	public void setCertFilename (String CertFilename)
	{

		if (CertFilename != null && CertFilename.length() > 255)
		{
			log.warning("Length > 255 - truncated");
			CertFilename = CertFilename.substring(0, 255);
		}
		set_Value (COLUMNNAME_CertFilename, CertFilename);
	}

	/** Get CertFilename.
		@return Filename of certificate to use with the Payment Processor.
	  */
	public String getCertFilename () 
	{
		return (String)get_Value(COLUMNNAME_CertFilename);
	}

	...
	implements ListSelectionListener
{
	...
	private CCheckBox hideAssigned = new CCheckBox (Msg.getMsg(Env.getCtx(), "HideAssigned")); // JH
	//
	...
	private void jbInit() throws Exception
	{
		...
		northPanel.add(hideAssigned, BorderLayout.WEST); // JH
		hideAssigned.addActionListener(this); // JH
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		// JH
		else if (e.getSource() == hideAssigned)
		{
			refresh();
		}
	}	//	actionPerformed
